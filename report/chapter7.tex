...
The OpenTelemetry guidance on collector scaling and bottleneck identification supports this concern, because a centralized collector can become the limiting component once telemetry volume increases beyond a small deployment footprint \cite{opentelemetryCollectorScaling}.
